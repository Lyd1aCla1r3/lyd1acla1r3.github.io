...
Let the original stream entering this phase be defined as $X_1$. This tensor contains the original embeddings enriched with the outputs of the Attention mechanism.
